...
class TestData:
    def __init__(self):
        self.test_contacts = {
            ...
            6 : Record("Michał Kamiński","730 444 555","mkamiński@email.com", "1997-09-18",
            ...
            8 : Record("Tomasz Zając", "516 666 777", "tzając@email.com", "1980-04-09",
                       "Olsztyn, 10-100, Aleja Zielona 12",
                       "Szkola",
                       "Nauczyciel od matematyki dziecka",
                       ),
            9 : Record("Natalia Szymańska", "660 777 888", "nszymańska@email.com", "1994-11-19",
                       "Katowice, 40-400, ul. Słowackiego 9/2",
                       "Dentysta",
                       "Ciezko z terminami",
                       ),
            10 : Record("Marcin Dąbrowski", "780 888 999", "mdąbrowski@email.com", "1987-08-03",
